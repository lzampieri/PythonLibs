import pandas as pd
from . import rspro, nicolet, opus, gc
...
def load_data( dataset, folder, load_all = False, to_load = ['rspro','nicolet_SPA','nicolet_SRS','opus','gc'] ):
...
def load_index_and_data( folder, index_filename = "index.xlsx", load_all = False, update_index = False, to_load = ['rspro','nicolet_SPA','nicolet_SRS','opus','gc'], load_only = [] ):
